...
const Sidebar = () => {
  ...
  const Menus = [
    ...
    {
      title: "Setting",
      src: "https://raw.https://raw.githubusercontent.com/Sridhar-C-25/sidebar_reactTailwind/main/src/assets/Setting.png.com/Sridhar-C-25/sidebar_reactTailwind/main/src/assets/User.png",
    },
  ];
  return (
    <>
